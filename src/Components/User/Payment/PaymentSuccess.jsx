            ...
            <div className="bg-white p-6  md:mx-auto">
                ...
                <div className="text-center">
                    ...
                    <div className="md:px-24 px-2 flex justify-end text-center">
                        <p  onClick={handleGeneratePdf} className=" text-black font-semibold py-3">
                            print Invoice
                        </p>
                    </div>
                    <div className='flex  flex-col md:flex-row justify-between md:justify-center items-center'>
                    <div ref={reportTemplateRef} id='div-to-download' className='max-w-[750px] md:h-[35rem] p-2 bg-slate-100 w-[95%] rounded-lg mb-3 shadow-2xl border-2'>
                        <p className='text-center text-2xl font-bold py-3'>Invoice</p>
                        <hr className='' />
